...
CREATE (b1)-[:BELONGS_TO]->(d)
CREATE (b1)-[:HAS_STATUS]->(s)
CREATE (q0:Question {values:'{}', questionId:'text', number:2, question:'delivery type',  type:'options', values:'{"options":"amazon,registered letter, parcel, groceries, flowers, other","multiple":"single","none":true}'})
