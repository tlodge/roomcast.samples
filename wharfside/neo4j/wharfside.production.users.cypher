...
CREATE (user2:User {userId:'u4',username:'resident2', firstname:'Test Resident Two', surname:'Smithy', email:'tlodge@gmail.com', mobile:'07972639571', role:'user', created:1441890901000, validated:1441890951000,  password:'$2a$10$sS6UsIJHkB9UYfHZzMBZke7iXXyQ1sX5hsl7Tb5LkjhzjHlV.UpL2', sex:'female'})-[:AFFILIATED_WITH]->(d)
CREATE (user3:User {userId:'u5',username:'resident3', firstname:'Test Resident Three', surname:'Smithee', email:'tlodge@gmail.com', mobile:'07972639571', role:'user', created:1441890901000, validated:1441890951000,  password:'$2a$10$W2Yaa4JpsMfsI6zGC/3Piei5dNjDCZtbb/Blgq.IZ93zf7fhUNFoW', sex:'female'})-[:AFFILIATED_WITH]->(d)
CREATE (user4:User {userId:'u6',username:'resident4', firstname:'Test Resident Four', surname:'Smyte', email:'tlodge@gmail.com', mobile:'07972639571', role:'user', created:1441890901000, validated:1441890951000,  password:'$2a$10$wAh.Khr3Tl/NKE45Y7LnT.0ltmlgdbID4ctC9fexLROIJYFZkOepu', sex:'female'})-[:AFFILIATED_WITH]->(d);
